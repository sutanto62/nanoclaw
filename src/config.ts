...
export const DIGEST_INTERVAL_MS = parseInt(
  process.env.DIGEST_INTERVAL_MS || envConfig.DIGEST_INTERVAL_MS || '3600000', // 1 hour
  10,
);
export const DIGEST_LOOKBACK_HOURS = parseInt(
  process.env.DIGEST_LOOKBACK_HOURS || envConfig.DIGEST_LOOKBACK_HOURS || '24',
  10,
);
